      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/T5B55",
                   'caption'=>'تمت البرمجه بواسطه (@T5B55) 💸',
             ...
             $bot->sendvideo([ 'chat_id'=>$chatId,
                 ...
                 $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/SALAMMZORI",
                   'caption'=>'بصمه تعليم السحب ♻️',

                ]);
                
                $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/T5B55",
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 تواصل المطور 』','url'=>'t.me/salammzori']],
                          [['text'=>"▪️| قناه البوت", 'url'=>"t.me/T5B55"]],
                      ]
                  ])
              ]);   
				}
